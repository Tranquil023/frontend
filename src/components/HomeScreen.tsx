...
const HomeScreen: React.FC = () => {
    ...
    const specialPlan = { name: 'Limited Offer', price: '₹800', dailyProfit: '₹1500', totalIncome: '₹1500', duration: '1 Days' };
                ...
                <div className="px-6 space-y-6 mt-6">
                    ...
                    <div className="bg-yellow-500 rounded-xl p-4 shadow-2xl mt-8">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="bg-gray-700 text-white px-3 py-0.5 rounded-full text-xs font-medium"> Days:1 </div>
                        </div>
